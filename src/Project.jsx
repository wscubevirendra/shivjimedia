...
const Projects = () => {
  return (
    <section className="bg-gray-200 py-8" id="projects">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <article key={index} className="bg-white p-4 rounded-lg shadow-lg transition-colors duration-300 hover:bg-gray-100">
              ...
              <div className="flex space-x-4">
                <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-red-500">
                  <Button>
                    Call Now
                  </Button>
                </a>
